...
<!--
	Author: W3layouts
	Developed By singothu abhilash
...
<html lang="zxx">
<head>
<title>Kerala School an Education Category Bootstrap Responsive Website Template | Home :: </title>
<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Kerala School web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Kerala School</a></h1>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			...
			<div data-video="E91gAjunqOM" id="video"> <img src="images/banner5.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		<div class="stats-info">
			...
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='100' data-delay='.5' data-increment="1">100</div>
				
				<h4 class="stats-info">CLASSES COMPLETE</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				<i class="fa fa-trophy" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='300' data-delay='.5' data-increment="10">300</div>
				
				<h4 class="stats-info">STUDENTS ENROLLED</h4>
			</div>
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
					<i class="fa fa-user" aria-hidden="true"></i>
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='88' data-delay='.5' data-increment="1">88</div>
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/abhi1.jpg" class="swipebox"><img src="images/abhi1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Kerala School</h4>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/abhi2.jpg" class="swipebox"><img src="images/abhi2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Kerala School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/abhi6.jpg" class="swipebox"><img src="images/abhi6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Kerala School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/abhi4.jpg" class="swipebox"><img src="images/abhi4.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Kerala School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/abhi5.jpg" class="swipebox"><img src="images/abhi5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Kerala School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
...
<div class="team-w3l" id="team">
	<div class="container">
		<h3 class="w3l-title">Our Skilled Faculties</h3>
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
		</div>
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft vincent">
				<div class="about_img"><img src="images/vincent.jpg" alt="">
				  <h5>Vincent</h5>
				  <div class="about_opa">
					<p>Professor</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft babu">
				<div class="about_img"><img src="images/babu1.jpg" alt="">
				  <h5>Babu Panthaplackal</h5>
				  <div class="about_opa">
			...
			<div class="col-md-4 col-xs-4 about-poleft rajan">
				<div class="about_img"><img src="images/rajan.jpg" alt="">
				  <h5>Rajan</h5>
				  <div class="about_opa">
					<p>Lecturers</p>
					<ul class="fb_icons2 text-center">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft vincent">
				<div class="about_img"><img src="images/prathish.jpg" alt="">
				  <h5>Pratheesh Mathew</h5>
				  <div class="about_opa">
					<p>Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft lissy">
				<div class="about_img"><img src="images/antony.jpg" alt="">
				  <h5>Antony</h5>
				  <div class="about_opa">
					<p>Senior Lecturers</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft babu">
				<div class="about_img"><img src="images/sheeja.jpg" alt="">
				  <h5>Sheeja</h5>
				  <div class="about_opa">
					<p>Lecturers</p>
					<ul class="fb_icons2 text-center">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 .Kerala School All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Singothu Abhilash</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 .Kerala School All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Ravi Khadka</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng(18.201221, 79.399709),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng(18.201221, 79.399709),
						map: map,
					});
				}
			</script>
