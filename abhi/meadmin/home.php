	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
				...
				<footer>
					<p>&copy 2018 Augment . All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a> and Develop By Singothu abhilash</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
		...
		<div class="sidebar-menu">
			<header class="logo">
				<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>abhilash</h1></span> 
			...
			<!--/down-->
			<div class="down">
				<a href="index.html"><img src="images/profile.jpg"></a>
				...
				<ul>
					...
					<li><a class="tooltips" href="home.php?ravi=edit-general-information"><span>Settings</span><i class="lnr lnr-cog"></i></a></li>
			...
			<div class="menu">
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>Database</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					...
					<ul id="menu-academico-sub">
						...
						<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Results</span> <span class="fa fa-angle-right" style="float: right"></span></a>
					<ul 	id="menu-academico-sub">
					<li id="menu-academico-avaliacoes"><a href="home.php?ravi=student-information">Class wise Results</a></li>	
				</ul>
