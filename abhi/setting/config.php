	...
	
{
	...
	/////////// add marks in student data by admin panel /////////////////////
		public function Class_wise_Results($std_name,$std_standard,$std_telugu,$std_hindi,$std_english,$std_maths,$std_science,$std_social,$std_rank,$std_grade,$std_remarks)
	{
		$add_student_insert = "insert into st_results(name,standard,telugu,hindi,english,maths,science,social,rank,grade,remarks,) value('$std_name','$std_standard','$std_telugu','$std_hindi','$std_english','$std_maths','$std_science','$std_social','$std_rank','$std_grade','$std_remarks')";
		$add_student_run = $this->connectdb->query($Class_wise_Results);
		return $add_student_run;
	}
