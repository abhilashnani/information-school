	...
	<div class="page-container">
		...
		<div class="left-content">
			<div class="inner-content">
								...
								<div class="graph">
									...
									<div class="content tab">
										...
										<div class="mediabox">
												...
												<p><strong>TELUGU: </strong>
													<?php echo ucfirst($student_name_display['roll_no']); ?>
												</p>
												<p><strong>        HINDI: </strong>
													<?php echo ucfirst($student_name_display['st_gender']); ?>
												</p>
				...
				<footer>
					<p>&copy 2018 Augment .Kerala School All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a> and Develop By Singothu Abhilash</p>
				</footer>
				<!--footer section end-->
			</div>
		</div>
