...
<body>
								<!--/login-->
									   ...
									   <div class="error_page">
										...
										<div class="footer">
												<div class="error-btn">
															<a class="read fourth" href="logouts.php">Cancel</a>
															
															
															</div>

										   <p>&copy 2016 Augment . Kerala School All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">W3layouts.</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
